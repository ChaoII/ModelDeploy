...
include_directories(${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal)
...
if (WIN32)
    ...
    set_source_files_properties("${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal/bias-lm.cpp" PROPERTIES COMPILE_OPTIONS "/Od")
    set_source_files_properties("${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal/itn-processor.cpp" PROPERTIES COMPILE_OPTIONS "/Od")
endif ()
...
file(GLOB ASR_INTERNAL_SOURCE "${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal/*.cpp")
if (APPLE)
    file(GLOB ITN_SOURCE "${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal/itn-*.cpp")
    list(REMOVE_ITEM ASR_INTERNAL_SOURCE ${ITN_SOURCE})
endif (APPLE)
list(REMOVE_ITEM ASR_INTERNAL_SOURCE "${CMAKE_SOURCE_DIR}/csrc/audio/asr/internal/paraformer-torch.cpp")
