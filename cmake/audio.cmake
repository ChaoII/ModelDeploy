...
option(SHERPA_ONNX_ENABLE_BINARY "Whether to build binaries" OFF)
...
option(SHERPA_ONNX_BUILD_C_API_EXAMPLES "Whether to enable C API examples" OFF)
...
include_directories("${CMAKE_SOURCE_DIR}/csrc/audio")
...
list(APPEND CMAKE_MODULE_PATH "${CMAKE_SOURCE_DIR}/csrc/audio/sherpa-onnx/cmake")
...
add_subdirectory("${CMAKE_SOURCE_DIR}/csrc/audio/sherpa-onnx/csrc")
...
if (NOT BUILD_SHARED_LIBS)
    ...
    if (SHERPA_ONNX_ENABLE_TTS)
        configure_file(${CMAKE_SOURCE_DIR}/csrc/audio/sherpa-onnx/cmake/sherpa-onnx-static.pc.in ${PROJECT_BINARY_DIR}/sherpa-onnx.pc @ONLY)
    else ()
        configure_file(${CMAKE_SOURCE_DIR}/csrc/audio/sherpa-onnx/cmake/sherpa-onnx-static-no-tts.pc.in ${PROJECT_BINARY_DIR}/sherpa-onnx.pc @ONLY)
    endif ()
else ()
    configure_file(${CMAKE_SOURCE_DIR}/csrc/audio/sherpa-onnx/cmake/sherpa-onnx-shared.pc.in ${PROJECT_BINARY_DIR}/sherpa-onnx.pc @ONLY)
endif ()
