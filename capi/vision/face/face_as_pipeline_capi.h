...
MODELDEPLOY_CAPI_EXPORT MDStatusCode md_create_face_as_pipeline_model(MDModel* model,
...
MODELDEPLOY_CAPI_EXPORT MDStatusCode md_face_as_pipeline_predict(const MDModel* model, MDImage* image,
