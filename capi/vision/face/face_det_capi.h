...
/// 打印检测结果
MODELDEPLOY_CAPI_EXPORT void md_print_face_det_result(const MDKeyPointResults* c_results);
...
MODELDEPLOY_CAPI_EXPORT void md_free_face_det_result(MDKeyPointResults* c_results);
