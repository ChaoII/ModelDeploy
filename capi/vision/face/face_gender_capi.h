...
MODELDEPLOY_CAPI_EXPORT MDStatusCode md_create_face_gender_model(
...
MODELDEPLOY_CAPI_EXPORT MDStatusCode md_face_gender_predict(
    const MDModel* model, MDImage* image, MDFaceGenderResult* c_result);
