...
namespace modeldeploy {
    void OrtBackendImpl::build_option(const OrtBackendOption& option) {
        option_ = option;
    ...
    bool OrtBackendImpl::init(const RuntimeOption& option) {
    ...
    bool OrtBackendImpl::init_from_onnx(const std::string& model_buffer, const OrtBackendOption& option) {
        if (initialized_) {
    ...
    TensorInfo OrtBackendImpl::get_input_info(const int index) {
        TensorInfo info;
    ...
    TensorInfo OrtBackendImpl::get_output_info(const int index) {
        TensorInfo info;
    ...
    std::map<std::string, std::string> OrtBackendImpl::get_custom_meta_data() const {
