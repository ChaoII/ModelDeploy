...
namespace modeldeploy {
    ...
    std::unique_ptr<TrtBackendImpl> TrtBackendImpl::clone(const RuntimeOption& runtime_option,
        ...
        // }
        // else {
        //     if (cudaStreamCreate(&new_backend->stream_) != 0) {
        //         MD_LOG_FATAL << "Cant not call cudaStreamCreate()." << std::endl;;
        //     }
        // }
        // new_backend->inputs_desc_.assign(inputs_desc_.begin(), inputs_desc_.end());
        // new_backend->outputs_desc_.assign(outputs_desc_.begin(),
        //                                      outputs_desc_.end());
        //
        // new_backend->shape_range_info_.insert(shape_range_info_.begin(), shape_range_info_.end());
        ...
        // new_backend->get_input_output_info();
