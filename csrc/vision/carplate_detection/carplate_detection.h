...
namespace modeldeploy::vision::facedet {
     ...
     */
    class MODELDEPLOY_CXX_EXPORT CarPlateDetection : public BaseModel {
    public:
         ...
         */
        explicit CarPlateDetection(const std::string &model_file,
         ...
         */
        bool predict(cv::Mat *im, FaceDetectionResult *result, float conf_threshold = 0.25,
