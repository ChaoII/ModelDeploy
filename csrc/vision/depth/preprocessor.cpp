...
namespace modeldeploy::vision::detection {
    UltralyticsDepthPreprocessor::UltralyticsDepthPreprocessor() {
        size_ = {640, 640};
        padding_value_ = {114.0, 114.0, 114.0};
    }

    bool UltralyticsDepthPreprocessor::preprocess(const ImageData& image, Tensor* output,
    ...
    bool UltralyticsDepthPreprocessor::run(
    ...
    bool UltralyticsDepthPreprocessor::run(const uint8_t* src_y,
