 ...
 */
    ...
    public:
         ...
         */
        explicit CarPlateRecognizer(const std::string &model_file, const RuntimeOption &custom_option = RuntimeOption());
         ...
         */
        bool predict(cv::Mat *im, CarPlateRecognizerResult *result);
        ...
        */
        ...
        std::string plate_chr[78] = {"#", "京", "沪", "津", "渝", "冀", "晋", "蒙", "辽", "吉", "黑", "苏",
    ...
    private:
        ...
        bool postprocess(std::vector<MDTensor> &infer_result, CarPlateRecognizerResult *result);
