...
namespace modeldeploy::vision::face {
    ...
    bool ScrfdPreprocessor::preprocess(cv::Mat* mat, Tensor* output, LetterBoxRecord* letter_box_record) const {
        // scrfd's preprocess steps
        // 1. letterbox
        // 2. BGR->RGB
        // 3. HWC->CHW
        utils::letter_box(mat, size_, is_scale_up_, is_mini_pad_, is_no_pad_, padding_value_, stride_,letter_box_record);
        BGR2RGB::apply(mat);
