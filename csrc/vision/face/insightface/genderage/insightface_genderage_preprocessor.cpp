//
// insightface buffalo_l genderage 前处理实现。
...
namespace modeldeploy::vision::face {
    ...
    InsightFaceGenderAgePreprocessor::InsightFaceGenderAgePreprocessor() {
        size_ = {96, 96};
    }

    bool InsightFaceGenderAgePreprocessor::run(const ImageData& image, const std::array<float, 4>& bbox,
