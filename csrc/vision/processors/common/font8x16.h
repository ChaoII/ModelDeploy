//
// Shared 8x16 VGA font bitmap (ASCII 0x20-0x7E), from dhepper/font8x8 (font8x16_basic, CC0).
// Single source of truth for BOTH the CPU NV12 drawing (draw_nv12.cpp) and the CUDA
// kernel atlas upload (draw_gpu.cu). Keep data here; do not duplicate.
//
#pragma once
#include <cstdint>

namespace modeldeploy::vision::font8x16 {
    inline const uint8_t kFont8x16[95][16] = {
        /* ' ' 0x20 */
