...
namespace modeldeploy::vision::ocr {
    ...
    public:
        ...
        std::string get_det_db_score_mode() const { return det_db_score_mode_; }

        /// Set use_dilation for the detection postprocess, default is fasle
        void set_use_dilation(int use_dilation) { use_dilation_ = use_dilation; }
        /// Get use_dilation of the detection postprocess
        int get_use_dilation() const { return use_dilation_; }
