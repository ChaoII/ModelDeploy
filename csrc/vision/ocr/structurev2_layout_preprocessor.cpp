...
namespace modeldeploy::vision::ocr {
    ...
    std::array<int, 4> StructureV2LayoutPreprocessor::GetLayoutImgInfo(cv::Mat* img) {
    ...
    bool StructureV2LayoutPreprocessor::ResizeLayoutImage(cv::Mat* img, int resize_w,
                                                          int resize_h) {
    ...
    bool StructureV2LayoutPreprocessor::Apply(std::vector<cv::Mat>* image_batch,
