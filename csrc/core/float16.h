//
// Created by aichao on 2025/3/27.
//
#pragma once
...
#if !defined(_WIN32)
#define MD_ALIGN(x) __attribute__((aligned(x)))
#else
#define MD_ALIGN(x) __declspec(align(x))
#endif

namespace modeldeploy {

    struct MD_ALIGN(2) float16 {
    public:
        uint16_t x;
...
#if defined(MD_WITH_NATIVE_FP16)
...
// so that .cu files can be successfully compiled by nvcc.
    template<>
    struct is_pod<modeldeploy::float16> {
        static const bool value = is_trivial<modeldeploy::float16>::value &&
                                  is_standard_layout<modeldeploy::float16>::value;
    };

    template<>
    struct is_floating_point<modeldeploy::float16>
            : std::integral_constant<
                    bool, std::is_same<modeldeploy::float16,
                            typename std::remove_cv<
                                    modeldeploy::float16>::type>::value> {
    };
    template<>
    struct is_signed<modeldeploy::float16> {
        static const bool value = true;
    };

    template<>
    struct is_unsigned<modeldeploy::float16> {
        static const bool value = false;
    };

    inline bool isnan(const modeldeploy::float16 &a) { return modeldeploy::isnan(a); }

    inline bool isinf(const modeldeploy::float16 &a) { return modeldeploy::isinf(a); }

    template<>
    struct numeric_limits<modeldeploy::float16> {
        ...
        static modeldeploy::float16 (min)() {
            return modeldeploy::raw_uint16_to_float16(0x400);
        }

        static modeldeploy::float16 lowest() {
            return modeldeploy::raw_uint16_to_float16(0xfbff);
        }

        static modeldeploy::float16 (max)() {
            return modeldeploy::raw_uint16_to_float16(0x7bff);
        }

        static modeldeploy::float16 epsilon() {
            return modeldeploy::raw_uint16_to_float16(0x0800);
        }

        static modeldeploy::float16 round_error() { return modeldeploy::float16(0.5); }

        static modeldeploy::float16 infinity() {
            return modeldeploy::raw_uint16_to_float16(0x7c00);
        }

        static modeldeploy::float16 quiet_NaN() {
            return modeldeploy::raw_uint16_to_float16(0x7e00);
        }

        static modeldeploy::float16 signaling_NaN() {
            return modeldeploy::raw_uint16_to_float16(0x7e00);
        }

        static modeldeploy::float16 denorm_min() {
            return modeldeploy::raw_uint16_to_float16(0x1);
        }
    };

    inline modeldeploy::float16 abs(const modeldeploy::float16 &a) {
        return modeldeploy::abs(a);
    }
