...
namespace modeldeploy::vision {
    void bind_ocr_db(const pybind11::module& m) {
        ...
        pybind11::class_<ocr::DBDetector, std::shared_ptr<ocr::DBDetector>, BaseModel>(m, "DBDetector")
            ...
            .def("predict",
                 [](ocr::DBDetector& self, const pybind11::array& image) {
                     ...
                     self.predict(ImageData(mat), &ocr_result);
                     return ocr_result;
                 }, pybind11::arg("image"))
            ...
            .def("clone", [](const ocr::DBDetector& self) {
                return self.clone();
            });
    }
