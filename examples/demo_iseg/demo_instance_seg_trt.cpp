...
int main() {
    ...
    // ---- 2. 加载模型（实例分割）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsSeg>("../../test_data/test_models/trt/yolo26n/yolo26n-seg.engine", opt);
    ...
    (void)vis.imwrite("result_instance_seg_trt.jpg");
