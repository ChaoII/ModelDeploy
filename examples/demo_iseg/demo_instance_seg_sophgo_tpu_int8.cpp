// ModelDeploy demo: 实例分割（sophgo_tpu_int8）。
...
int main() {
    ...
    // ---- 2. 加载模型（实例分割）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsSeg>("../../test_data/test_models/sophgo/yolo26n/yolo26n-seg_INT8.bmodel", opt);
    ...
    (void)vis.imwrite("result_instance_seg_sophgo_tpu_int8.jpg");
