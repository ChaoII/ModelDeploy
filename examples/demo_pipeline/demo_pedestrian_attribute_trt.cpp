...
int main() {
    ...
    auto m = std::make_unique<modeldeploy::vision::pipeline::PedestrianAttribute>("../../test_data/test_models/trt/zhgd_det.engine", "../../test_data/test_models/trt/zhgd_ml.engine", opt);
    ...
    (void)vis.imwrite("result_pedestrian_attribute_trt.jpg");
