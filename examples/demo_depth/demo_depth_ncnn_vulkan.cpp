// ModelDeploy demo: 深度估计（ncnn_vulkan）。
...
int main() {
    ...
    // ---- 2. 加载模型（深度估计）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsDepth>("../../test_data/test_models/ncnn/yolo26n/yolo26n-depth.param", opt);
    ...
    (void)vis.imwrite("result_depth_ncnn_vulkan.jpg");
