...
int main() {
    ...
    // ---- 2. 加载模型（深度估计）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsDepth>("../../test_data/test_models/trt/yolo26n/yolo26n-depth.engine", opt);
    ...
    (void)vis.imwrite("result_depth_trt.jpg");
