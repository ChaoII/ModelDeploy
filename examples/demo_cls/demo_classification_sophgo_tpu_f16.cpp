// ModelDeploy demo: 图像分类（sophgo_tpu_f16）。
...
int main() {
    ...
    // ---- 2. 加载模型（图像分类）----
    auto m = std::make_unique<modeldeploy::vision::classification::Classification>("../../test_data/test_models/sophgo/yolo26n/yolo26n-cls-f16.bmodel", opt);
    ...
    (void)vis.imwrite("result_classification_sophgo_tpu_f16.jpg");
