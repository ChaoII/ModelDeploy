...
int main() {
    ...
    // ---- 2. 加载模型（图像分类）----
    auto m = std::make_unique<modeldeploy::vision::classification::Classification>("../../test_data/test_models/trt/yolo26n/yolo26n-cls.engine", opt);
    ...
    (void)vis.imwrite("result_classification_trt.jpg");
