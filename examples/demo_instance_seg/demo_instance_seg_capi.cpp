...
int main() {
    MDStatusCode ret;
    MDModel model;
    if (ret = md_create_instance_seg_model(&model, "../../test_data/test_models/yolov5l-seg.onnx", 8); ret) {
    ...
    md_draw_instance_seg_result(&im, &result, "../../test_data/msyh.ttc", 14, 0.5, 1);
