// ModelDeploy demo: 目标检测（sophgo_tpu_f16）。
...
int main() {
    ...
    // ---- 2. 加载模型（目标检测）----
    auto det = std::make_unique<modeldeploy::vision::detection::UltralyticsDet>("../../test_data/test_models/sophgo/yolo26n/yolo26n-f16.bmodel", opt);
    ...
    (void)vis.imwrite("result_detection_sophgo_tpu_f16.jpg");
