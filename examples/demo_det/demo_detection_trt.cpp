...
int main() {
    ...
    // ---- 2. 加载模型（目标检测）----
    auto det = std::make_unique<modeldeploy::vision::detection::UltralyticsDet>("../../test_data/test_models/trt/yolo26n/yolo26n.engine", opt);
    ...
    (void)vis.imwrite("result_detection_trt.jpg");
