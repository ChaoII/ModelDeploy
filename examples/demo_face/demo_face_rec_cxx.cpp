...
int main() {
    ...
    auto im0 = modeldeploy::ImageData::imread("../../test_data/test_images/test_face_id1.jpg");
    auto im1 = modeldeploy::ImageData::imread("../../test_data/test_images/test_face_id4.jpg");
