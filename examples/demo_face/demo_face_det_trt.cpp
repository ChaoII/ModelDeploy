...
int main() {
    ...
    // ---- 2. 加载模型（人脸检测）----
    auto m = std::make_unique<modeldeploy::vision::face::Scrfd>("../../test_data/test_models/trt/scrfd_2.5g.engine", opt);
    ...
    (void)vis.imwrite("result_face_det_trt.jpg");
