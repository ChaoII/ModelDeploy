// ModelDeploy demo: 车牌识别（ncnn_vulkan）。
...
int main() {
    ...
    // ---- 2. 加载模型（车牌识别：检测 + 识别）----
    auto m = std::make_unique<modeldeploy::vision::lpr::LprPipeline>("../../test_data/test_models/ncnn/yolov5plate/yolov5plate.param", "../../test_data/test_models/ncnn/plate_recognition_color/plate_recognition_color.param", opt);
    ...
    (void)vis.imwrite("result_lpr_pipeline_ncnn_vulkan.jpg");
