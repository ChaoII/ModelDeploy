...
int main() {
    ...
    // ---- 2. 加载模型（车牌识别：检测 + 识别）----
    auto m = std::make_unique<modeldeploy::vision::lpr::LprPipeline>("../../test_data/test_models/trt/yolov5plate.engine", "../../test_data/test_models/trt/plate_recognition_color.engine", opt);
    ...
    (void)vis.imwrite("result_lpr_pipeline_trt.jpg");
