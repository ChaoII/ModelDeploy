// ModelDeploy demo: 姿态估计（mnn_opencl）。
...
int main() {
    ...
    // ---- 2. 加载模型（姿态估计）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsPose>("../../test_data/test_models/mnn/yolo26n/yolo26n-pose.mnn", opt);
    ...
    (void)vis.imwrite("result_pose_mnn_opencl.jpg");
