// ModelDeploy demo: 姿态估计（ncnn_vulkan）。
...
int main() {
    ...
    // ---- 2. 加载模型（姿态估计）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsPose>("../../test_data/test_models/ncnn/yolo26n/yolo26n-pose.param", opt);
    ...
    (void)vis.imwrite("result_pose_ncnn_vulkan.jpg");
