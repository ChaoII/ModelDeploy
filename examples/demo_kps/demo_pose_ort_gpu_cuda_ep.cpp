// ModelDeploy demo: 姿态估计（ort_gpu_cuda_ep）。
...
int main() {
    ...
    // ---- 2. 加载模型（姿态估计）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsPose>("../../test_data/test_models/onnx/yolo26n/yolo26n-pose.onnx", opt);
    ...
    (void)vis.imwrite("result_pose_ort_gpu_cuda_ep.jpg");
