// ModelDeploy demo: 语义分割（sophgo_tpu_f16）。
...
int main() {
    ...
    // ---- 2. 加载模型（语义分割）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsSem>("../../test_data/test_models/sophgo/yolo26n/yolo26n-sem-f16.bmodel", opt);
    ...
    (void)vis.imwrite("result_sem_sophgo_tpu_f16.jpg");
