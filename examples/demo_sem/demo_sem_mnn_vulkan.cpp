// ModelDeploy demo: 语义分割（mnn_vulkan）。
...
int main() {
    ...
    // ---- 2. 加载模型（语义分割）----
    auto m = std::make_unique<modeldeploy::vision::detection::UltralyticsSem>("../../test_data/test_models/mnn/yolo26n/yolo26n-sem.mnn", opt);
    ...
    (void)vis.imwrite("result_sem_mnn_vulkan.jpg");
