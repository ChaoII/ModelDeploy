// ModelDeploy demo: 光学字符识别（mnn_vulkan）。
...
int main() {
    ...
    auto m = std::make_unique<modeldeploy::vision::ocr::PaddleOCR>("../../test_data/test_models/mnn/ocr/ppocrv6_tiny/det_infer.mnn", "../../test_data/test_models/mnn/ocr/ppocrv6_tiny/cls_infer.mnn", "../../test_data/test_models/mnn/ocr/ppocrv6_tiny/rec_infer.mnn", dict, opt);
    ...
    (void)vis.imwrite("result_ocr_pipeline_mnn_vulkan.jpg");
