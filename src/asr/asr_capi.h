...
EXPORT_DECL MDStatusCode md_create_asr_model(MDModel *model,
...
EXPORT_DECL MDStatusCode md_asr_model_predict(MDModel *model, const char *wav_path,
                                              MDASRResult *asr_result, int audio_fs = 16000);

EXPORT_DECL void md_free_asr_result(MDASRResult *asr_result);

EXPORT_DECL void md_free_asr_model(MDModel *model);
